<footer class="bg-white my-4 rounded-lg">
    <div class="mx-auto w-full max-w-screen-xl p-3 py-2 lg:py-2">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline">smansagong</a>. All Rights Reserved.</span>
